...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body>
            ...
            <h1 class="text-center">Listado de vehículos terrestres</h1>
            <br/>
            <table class="table table-bordered" width="80%" id="users-table">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><?php echo e($a->flo_te_nacional); ?></td>
                    <td><?php echo e($a->flo_tipo); ?></td>
                    <td><?php echo e($a->flo_te_serial_motor); ?></td>
