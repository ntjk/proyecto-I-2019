    ...
    <body>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td name="hidden3">
                      ...
                      <button class="btn btn-info btn-detail factura" id=".<?php echo e($envio->en_clave); ?>." value=".<?php echo e($envio->en_clave); ?>." onclick="navigate(this,'<?php echo e($envio->en_clave); ?>')" name="factura">Factura</button>
                    </td>
                  </tr>
        ...
        <script>
          function navigate(link, inputid){
            ...
            var url = "<?php echo e(url('/envio')); ?>" + inputid;
