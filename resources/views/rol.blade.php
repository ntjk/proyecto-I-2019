    ...
    <div class="modal-footer">
     ...
     <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        ...
        <script>$(function() {
            ...
            var eliminar = '{!! verificarPermisosHelper("eliminar roles"); !!}';
            var modificar = '{!! verificarPermisosHelper("modificar roles"); !!}';
            var insertar = '{!! verificarPermisosHelper("insertar roles"); !!}';
