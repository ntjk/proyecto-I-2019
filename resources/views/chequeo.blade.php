...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
            ...
            <div class="container">
            <br/>
            <h1 class="text-center">Rastreo del envío {{$envio}}</h1>
            <br/>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <button class="btn btn-danger btn-delete delete" id="{{$c->che_clave}}" value="{{$c->che_clave}}" name="delete">Delete</button>
                    </td>
                  </tr>
                  @endforeach
                </tbody>
  ...
  <form method="post" id="user_form" enctype="multipart/form-data">
   <div class="modal-content">
    ...
    <div class="modal-footer">
     <input type="hidden" name="fk_envio" id="fk_envio" value={{$envio}}> 
